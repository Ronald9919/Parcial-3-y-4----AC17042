...
public class TorresGrafica extends Applet implements Runnable {
   ...
   */
   ...
   synchronized void drawCurrentFrame(Graphics g) {
      ...
      if (moveDisk > 0) {
         ...
         g.fillRoundRect(75+140*moveTower - 5*moveDisk - 5, 116-12*towerHeight[moveTower], 10*moveDisk+10, 10, 10, 10);
      }
   }
